...
// 后端接口
live2d_settings['modelAPI'] = '//api.gwl6.vip/';   // 自建 API 修改这里
...
live2d_settings['modelTexturesId'] = 68;           // 默认材质 ID，可在 F12 控制台找到
...
live2d_settings['waifuEdgeSide'] = 'left:230';     // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
